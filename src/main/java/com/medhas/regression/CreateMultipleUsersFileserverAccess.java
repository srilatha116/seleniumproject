 ...
 *
 */
public class CreateMultipleUsersFileserverAccess {

	WebDriver driver;

	public CreateMultipleUsersFileserverAccess(WebDriver driver) {
		this.driver = driver;
	}
	...
	@FindBy(xpath = "//div[@class='p-col-4 right-border selectable-user-category']//div[2]//div[2]//div[1]//div[2]")
	public WebElement multipleusersrdbton;
	...
	public WebElement AddUserBton;

	// 2nd UserDetails
	@FindBy(xpath = "(//span[text()='User Details'])[2]")
	public WebElement userdetailsaccordion;

	@FindBy(xpath = "(//input[@name='LoginDomain'])[2]")

	public WebElement userNTidsearchfield2;

	@FindBy(xpath = "//div[@class='dropdown-item']")
	public WebElement userNTidkey2;

	@FindBy(xpath = "(//input[@name='EmployeeId'])[2]")
	public WebElement empidtxtfield2;

	@FindBy(xpath = "(//input[@name='JobTitle'])[2]")
	public WebElement jobtitiletxtfield2;

	@FindBy(xpath = "(//input[@name='JobLocation'])[2]")
	public WebElement jobloctxtfield2;

	@FindBy(xpath = "(//input[@name='Department'])[2]")
	public WebElement departmenttxtfield2;

	// 2nduser - UserLineManager Details
	...
	public void seconduserDetails(String ntid2, String empid, String jobtitle, String Jobloc, String depid,
		...
		empidtxtfield2.sendKeys(empid);
		Thread.sleep(2000);

		jobtitiletxtfield2.sendKeys(jobtitle);

		jobloctxtfield2.sendKeys(Jobloc);

		departmenttxtfield2.sendKeys(depid);
