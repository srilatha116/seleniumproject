 ...
 *
 */
public class MultipleusersModifyRequestforFileserver {

	WebDriver driver;

	public MultipleusersModifyRequestforFileserver(WebDriver driver) {
		this.driver = driver;
	}
	...
	@FindBy(how = How.XPATH, using = "//input[@name='FS_Privilege']")
	WebElement permissiontypedropdown2;

	@FindBy(how = How.XPATH, using = "//input[@name='FS_Drive']")
	WebElement Drivetxtfield2;

	@FindBy(how = How.XPATH, using = "//input[@name='FS_Folder']")
	WebElement Foldertxtfield2;
	...
	public void modifyaccess(String permissiontype, String drivename, String foldername, String remark, String eun,
			String epw) throws InterruptedException {

		editicon1.click();

		permissiontypedropdown1.sendKeys(Keys.CONTROL + "a");
		permissiontypedropdown1.sendKeys(Keys.DELETE);
		Thread.sleep(3000);

		permissiontypedropdown1.sendKeys(permissiontype);
		Thread.sleep(2000);
		permissiontypedropdown1.sendKeys(Keys.ARROW_DOWN);
		permissiontypedropdown1.sendKeys(Keys.ENTER);

		Thread.sleep(3000);

		Drivetxtfield1.sendKeys(Keys.CONTROL + "a");
		Drivetxtfield1.sendKeys(Keys.DELETE);
		Thread.sleep(3000);

		Drivetxtfield1.sendKeys(drivename);

		Foldertxtfield1.sendKeys(Keys.CONTROL + "a");
		Foldertxtfield1.sendKeys(Keys.DELETE);
		Thread.sleep(3000);

		Foldertxtfield1.sendKeys(foldername);

		Savebton1.click();

		editicon2.click();

		permissiontypedropdown2.sendKeys(Keys.CONTROL + "a");
		permissiontypedropdown2.sendKeys(Keys.DELETE);
		Thread.sleep(3000);

		permissiontypedropdown2.sendKeys(permissiontype);
		Thread.sleep(2000);
		permissiontypedropdown2.sendKeys(Keys.ARROW_DOWN);
		permissiontypedropdown2.sendKeys(Keys.ENTER);

		Thread.sleep(3000);

		Drivetxtfield2.sendKeys(Keys.CONTROL + "a");
		Drivetxtfield2.sendKeys(Keys.DELETE);
		Thread.sleep(3000);

		Drivetxtfield2.sendKeys(drivename);

		Foldertxtfield2.sendKeys(Keys.CONTROL + "a");
		Foldertxtfield2.sendKeys(Keys.DELETE);
		Thread.sleep(3000);
