 ...
 *
 */
public class ReactivateOnbehalfActivedirectoryforsingleleuser extends BaseClass {
	...
	public void Userdetails(String Ntid,String EmployeeId, String JobTitle,
			String JobLocation, String Department, String Supervisor) throws InterruptedException {
		Thread.sleep(1500);
		userexpansion.click();
		Thread.sleep(2000);
		NTid.sendKeys(Ntid);
