 ...
 *
 */
public class PendingApprovalsforAppBulk {

	WebDriver driver;

	public PendingApprovalsforAppBulk(WebDriver driver) {
		this.driver = driver;
	...
	public void approvalworkflowaccessSO(String euser, String epwd) throws InterruptedException {
	...
	public void approvalworkflowaccesssystemadmin(String euser, String epwd) throws InterruptedException {
	...
	public void rejectflowaccesswithSO(String euser, String epwd) throws InterruptedException {
