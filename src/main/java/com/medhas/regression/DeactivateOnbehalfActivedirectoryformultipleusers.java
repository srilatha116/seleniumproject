 ...
 *
 */
public class DeactivateOnbehalfActivedirectoryformultipleusers extends BaseClass {
	WebDriver driver;
	...
	public void multipleUserdetailstcreation(String multipleNtid, String Supervisor, String FirstName, String LastName,
			String EmployeeId, String JobTitle, String JobLocation, String Department) throws InterruptedException {
		Thread.sleep(1500);
		userexpansion2.click();
		Thread.sleep(1000);
		NTid2.sendKeys(multipleNtid);
		Thread.sleep(2000);
		supervisoridkey.click();
		Thread.sleep(2000);
	...
	public void Remarks(String uid, String pass, String transferntid) throws InterruptedException {
		Thread.sleep(1000);
