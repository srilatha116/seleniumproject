 ...
 *
 */
public class CreateMultipleUsersOSAccess {

	WebDriver driver;

	public CreateMultipleUsersOSAccess(WebDriver driver) {
		this.driver = driver;
	...
	public void operatingsystemDetails(String Loc, String hostname, String softname, String remarkkey, String eun,
