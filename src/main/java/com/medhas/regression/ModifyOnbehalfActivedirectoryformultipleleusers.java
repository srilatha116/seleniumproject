 ...
 *
 */
public class ModifyOnbehalfActivedirectoryformultipleleusers extends BaseClass {
	WebDriver driver;
...
public void SelfCreateAccessRequest(String ActiveDirectoryRequest,String Employeestatus) throws InterruptedException{
	Thread.sleep(3000);
...
public void Userdetailstcreation(String Ntid,String Supervisor,String FirstName,String LastName,String EmployeeId,String JobTitle,String JobLocation,String Department) throws InterruptedException{
	Thread.sleep(2000);
	Adduserbutton.click();
	Thread.sleep(2000);
	Thread.sleep(1500);
...
public void Userdetailstcreationmultiple(String Ntid,String Supervisor,String FirstName,String LastName,String EmployeeId,String JobTitle,String JobLocation,String Department) throws InterruptedException{
	Thread.sleep(1500);
...
public void Activedirectorydetails(String DistributionList,String Comment,String uid,String pass) throws InterruptedException{
	Thread.sleep(1000);
