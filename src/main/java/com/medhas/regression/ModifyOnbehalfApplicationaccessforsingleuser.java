 ...
 *
 */
public class ModifyOnbehalfApplicationaccessforsingleuser extends BaseClass {

	WebDriver driver;

	public ModifyOnbehalfApplicationaccessforsingleuser(WebDriver driver) {
		this.driver = driver;
	...
	public void requestInfo(String RequestCate, String Employeestatus)
	...
	public void userDetails(String Ntid, 
			String EmployeeId, String JobTitle, String JobLocation, String Department,String Supervisor) throws InterruptedException {
		Thread.sleep(1500);
		userexpansion.click();
		Thread.sleep(1500);
		NTid.sendKeys(Ntid);
