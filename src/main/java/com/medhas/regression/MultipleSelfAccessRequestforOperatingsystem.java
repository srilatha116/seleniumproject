 ...
 *
 */
public class MultipleSelfAccessRequestforOperatingsystem {

	WebDriver driver;

	public MultipleSelfAccessRequestforOperatingsystem(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void operatingsystemDetails(String Loc, String hostname, String softname) throws InterruptedException {
	...
	public void addnewos(String Loc, String hostname, String softname, String remarkkey, String eun, String epw)
			throws InterruptedException {
