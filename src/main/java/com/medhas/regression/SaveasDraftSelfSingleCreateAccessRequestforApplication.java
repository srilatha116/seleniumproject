 ...
 *
 */
public class SaveasDraftSelfSingleCreateAccessRequestforApplication {
	
	WebDriver driver;
	WebDriverWait wait;
	
	public SaveasDraftSelfSingleCreateAccessRequestforApplication(WebDriver driver) {
		this.driver = driver;
	}
	...
	@FindBy(xpath = "//div[contains(text(),'Request Saved as Draft')]")
	public WebElement DraftrequesttoastMessage;
	...
	//TO pickup draft request
	@FindBy(xpath = "//div[@class='DRAFT']")
	public WebElement draftRequestpickup;
	
	
	@FindBy(xpath = "//div[contains(text(),'Successfully Updated Access Request')]")
	public WebElement submitDraftrequesttoastMessage;
	...
	public void selfDraftApplication(String Loc, String Systemtype, String Systemname, String Instrumentation,
...
public void Toastmsg() throws InterruptedException {
		...
		if (DraftrequesttoastMessage.isDisplayed()) {
			
			
			String expectedMessage = "Request Saved as Draft";
			String message = driver.findElement(By.xpath("//div[contains(text(),'Request Saved as Draft')]")).getText();
			System.out.println(DraftrequesttoastMessage.getText());
			Assert.assertEquals("Request Saved as Draft", expectedMessage);
...
public void submitDraftRequest(String epw) throws InterruptedException {
...
public void SubmitdraftToastmsg() throws InterruptedException {
	
	Thread.sleep(4000);

	if (submitDraftrequesttoastMessage.isDisplayed()) {
		
		
		String expectedMessage = "Successfully Updated Access Request";
		String message = driver.findElement(By.xpath("//div[contains(text(),'Successfully Updated Access Request')]")).getText();
		System.out.println(submitDraftrequesttoastMessage.getText());
		Assert.assertEquals("Successfully Updated Access Request", expectedMessage);
