 ...
 *
 */
public class ModifyOnbehalfActivedirectoryforsingleleuser extends BaseClass {
	WebDriver driver;
	...
	public void Userdetailstcreation(String Ntid, String Supervisor, String EmployeeId, String JobTitle,
			String JobLocation, String Department) throws InterruptedException {
		Thread.sleep(1500);
		userexpansion.click();
		Thread.sleep(4000);
		NTid.sendKeys(Ntid);
