 ...
 *
 */
public class DeactivateOnbehalfActivedirectoryforsingleuser extends BaseClass {
	WebDriver driver;
	...
	public void requestInfo(String Ntid, String Supervisor, String FirstName, String LastName,
