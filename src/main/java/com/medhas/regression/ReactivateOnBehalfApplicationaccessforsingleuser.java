 ...
 *
 */
public class ReactivateOnBehalfApplicationaccessforsingleuser extends BaseClass {
	WebDriver driver;
	...
	public void applicationDetails(String uid, String epw) throws InterruptedException {
		Thread.sleep(1000);
		DisplayAccessRequestbtn.click();
		Thread.sleep(2000);
		DisplayaccessCheckbox.click();
		Thread.sleep(2000);
		RequestCommenttextbox.sendKeys("Reactivate");
		Thread.sleep(1500);
		Submitbtn.click();
		Thread.sleep(2000);
