 ...
 *
 */
public class DeactivateOnbehalfApplicationaccessforsingleuser extends BaseClass {
	WebDriver driver;
...
public void SelfCreateAccessRequest(String ApplicationDirectoryRequest,String Employeestatus) throws InterruptedException{
	Thread.sleep(3000);
...
public void Applicationdetails(String Updatedsystemmrole,String Comment,String uid,String pass) throws InterruptedException{
	Thread.sleep(1000);
