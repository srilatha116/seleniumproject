 ...
 *
 */
public class TestAccessRequestPendingApprovals extends BaseClass {
	...
	public void approvalworkflowforaccessrequestwithHod() throws InterruptedException {
		...
		fileserveraccessrequestpending.approvalworkflowaccessHod(excel.getStringData("PendingApprovals", 1, 0),
				excel.getStringData("PendingApprovals", 1, 2));
	}
