 ...
 *
 */
public class TestRejectAccessRequestPendingApprovals extends BaseClass {
	...
	@Test(priority = 2)
	public void rejectAccessbyHOD() throws InterruptedException {
		...
		accessrequestpending.rejectflowaccess(excel.getStringData("PendingApprovals", 1, 0),
				excel.getStringData("PendingApprovals", 1, 2));
	...
	@Test(priority = 3)
	public void accessRequestRejected() throws InterruptedException {
		ApplicationRequestPendingApprovals accessrequestpending = PageFactory.initElements(driver,
				ApplicationRequestPendingApprovals.class);
