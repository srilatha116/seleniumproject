...
import com.medhas.regression.MultipleUsersDeactivaterequestforFileserver;
 ...
 *
 */
public class TestMultipleUsersDeactivaterequestforFileserver extends BaseClass {
	...
	public void enterrequestInfo() throws InterruptedException {
		MultipleUsersDeactivaterequestforFileserver multipleusersdeactivateforfileserver = PageFactory
				.initElements(driver, MultipleUsersDeactivaterequestforFileserver.class);
		multipleusersdeactivateforfileserver.requestInf(excel.getStringData("Selfcreaterequestforfileserver", 1, 0));
	}
	...
	public void enterfileserveraccess() throws InterruptedException {
		MultipleUsersDeactivaterequestforFileserver multipleusersdeactivateforfileserver = PageFactory
				.initElements(driver, MultipleUsersDeactivaterequestforFileserver.class);
		multipleusersdeactivateforfileserver.enterfileservername(excel.getStringData("Deactivate Fileserver", 1, 0),
	...
	public void enterfirstUserDetails() throws InterruptedException {
		MultipleUsersDeactivaterequestforFileserver multipleusersdeactivateforfileserver = PageFactory
				.initElements(driver, MultipleUsersDeactivaterequestforFileserver.class);
		multipleusersdeactivateforfileserver.userDetails1(excel.getStringData("UserDetails forDeactivateAccess", 1, 0),
	...
	public void entersecondUserDetails() throws InterruptedException {
		MultipleUsersDeactivaterequestforFileserver multipleusersdeactivateforfileserver = PageFactory
				.initElements(driver, MultipleUsersDeactivaterequestforFileserver.class);
		multipleusersdeactivateforfileserver.userDetails2(excel.getStringData("UserDetails forDeactivateAccess", 2, 0),
